...
namespace Workflow.Service.LogCounterManage
{
    ...
    public interface ILogCountersService
    {
		...
		/// 创建时间: 2009-2-10
		/// </remarks>
		IList<MachineType> GetNeedRecordWarchMachineAndMachineWatch();
		...
		/// 创建时间: 2009.5.4
		/// </remarks>
		int GetCompensateUsedPaperCount(long recordMachineWatchId, long machineTypeId, long paperId, long paperId2, string colorType, long paperId3);
		...
		/// 获取需要超标的所有订单
		/// </summary>
		/// <param name="lastRecordWath">上次抄表</param>
		/// <returns>订单</returns>
		/// <remarks>
		/// 作    者: 陈汝胤
		/// 创建时间: 2009-12-16
		/// </remarks>
		IList<Order> GetNeedRecordMachineWatch(RecordMachineWatch lastRecordWath);
		...
		/// 获取当前抄表的所有补单
		/// </summary>
		/// <param name="抄表id"></param>
		/// <returns></returns>
		/// <remarks>
		/// 作    者: 陈汝胤
		/// 创建时间: 2009-12-16
		/// </remarks>
		IList<CompensateUsedPaper> GetCompensateUsedPaperByRecordWatchId(long recordWatchId);
		...
		/// 获取指定抄表ID的结果
		/// </summary>
		/// <param name="recordMachineWatchId">recordMachineWatchId</param>
		/// <returns></returns>
		IList<DailyRecordMachine> GetRecordMachineWatchResult(long recordMachineWatchId);
		...
		long GetPaperSpecificationIdByName(string name);
		#endregion
	}
}
