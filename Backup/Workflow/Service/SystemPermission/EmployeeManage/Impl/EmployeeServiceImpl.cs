...
namespace Workflow.Service.SystemPermission.EmployeeManage.Impl
{
    public class EmployeeServiceImpl:IEmployeeService
    {
        ...
        public void DeleteEmployee(Employee employee)
        {
            ...
            employeeDao.DeleteAllUserByEmployee(employee.Employeeid);
		...
		public IList<Employee> SearechEmployee(long positionId)
		{
			return employeeDao.SearchEmployee(positionId);
		}
