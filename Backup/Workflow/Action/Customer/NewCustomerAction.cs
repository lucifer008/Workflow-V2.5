...
namespace Workflow.Action
{
    public class NewCustomerAction
    {
        ...
        public virtual void InsertCustomer()
        {
            ...
            linkMan.IdentityCardNo = model.IdentityNo;
            //插入客户,联系人
        ...
        public virtual void SearchAllNotValidate(int currentPageIndex)
        {
            ...
            hashCondition.Add("CustomerName",model.Name);
        ...
        public long SearchAllNotValidateRowCount() 
        {
            ...
            condition.Add("CustomerName", model.Name);
            return searchCustomerService.SearchAllNotValidateRowCount(condition);
        }
        #endregion
