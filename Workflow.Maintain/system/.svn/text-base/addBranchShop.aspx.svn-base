<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addBranchShop.aspx.cs" Inherits="system_addBranchShop" %>
...
<script type="text/javascript" src="../js/system/addBranchShop.js"></script>
<script type="text/javascript" language="javascript">
var companyId='<%=strCompany %>';
function loadData()
{
    if(""!=companyId)
    {
        $("#sltCompany").attr("value",companyId);
    }
}
</script>
<base target="_self" />
</head>
<body style="text-align:center" onload="loadData()">
		...
		<table width="100%" border="0" cellspacing="0">
			...
			<tr>
				...
				<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
					<tr>
					    <td nowrap class="item_caption">公司</td>
						<td class="item_content" align="left">
						    <select id="sltCompany" name="company">
						...
						<td class="item_content" align="left"><input id="txtBranchShopName" name="branchShopName" type="text" runat="server"/></td>
					</tr>
					<tr>
			...
			<tr id="tr1" runat="server">
			    ...
			    <table border="1" cellpadding="3" cellspacing="1" width="100%">
					<tr>
					<th  nowrap="nowrap" align="center" width="20%">所属公司</th>
					<th  nowrap="nowrap" align="center" width="30%">分店名称</th>
					<th  nowrap="nowrap" align="center" width="20%">备注</th>
					<th  nowrap width="10%"></th>
					</tr>
					<%
                        if (null != model.BranchShopList)
                        {
                            foreach (BranchShop c in model.BranchShopList)
                            { 
                            %>
                            <tr class="detailRow">
                                <td><%=c.CompanyName%></td>
                                <td class="branchShopName"><%=c.Name%></td>
                                <td class="memo"><%=c.Memo%></td>
					             <td>
					                <input type="hidden" name="branchShopId" value="<%=c.Id %>"/> 
					                <input type="hidden" name="companyId" value="<%=c.CompanyId %>"/> 
					                <a href="#" onclick="edmitBranchShop(this)" >编辑</a>&nbsp;
					                <a href="#" onclick="deleteBranchShop(this)">删除</a>
					             </td> 
					           </tr>
                       <%  }
                       }%>
