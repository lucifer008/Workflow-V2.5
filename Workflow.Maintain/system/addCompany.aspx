<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addCompany.aspx.cs" Inherits="system_addCompany" %>
...
<script type="text/javascript" src="../js/system/addCompany.js"></script>
<base target="_self" />
</head>
		...
		<table width="100%" border="0" cellspacing="0">
			...
			<tr>
				...
				<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
					<tr>
						...
						<td class="item_content" align="left"><input id="txtCompanyName" name="companyName" type="text" runat="server"/></td>
					</tr>
					<tr>
						<td nowrap class="item_caption">备注</td>
						<td class="item_content" align="left"><textarea id="txtMemo" name="memo" runat="server"  style="width: 100%" height="100%"></textarea></td>
					</tr>
				</table>
			</tr>
			<tr>
			...
			<tr id="tr1" runat="server">
			    ...
			    <table border="1" cellpadding="3" cellspacing="1" width="100%">
					<tr>
					<th  nowrap="nowrap" align="center" width="40%">名称</th>
					<th  nowrap="nowrap" align="center" width="40%">备注</th>
					<th  nowrap width="10%"></th>
					</tr>
					<%
                        if (null != model.CompanyList)
                        {
                            foreach (Company c in model.CompanyList)
                            { 
                            %>
                            <tr class="detailRow">
                                <td class="companyName"><%=c.Name%></td>
                                 <td class="memo"><%=c.Memo%></td>
					             <td>
					                <input type="hidden" name="companyId" value="<%=c.Id %>"/> 
					                <a href="#" onclick="edmitCompany(this)" >编辑</a>&nbsp;
					                <a href="#" onclick="deleteCompany(this)">删除</a>
					             </td> 
					           </tr>
                       <%  }
                       }%>
