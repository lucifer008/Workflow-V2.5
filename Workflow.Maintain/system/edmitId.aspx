			...
			<tr>
				...
				<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
					<tr>
						...
						<td class="item_content" align="left"><input id="txtFlagNo" name="falgNo" readonly="readonly" type="text" runat="server"/></td>
						
						<td nowrap class="item_caption">开始值</td>
						<td class="item_content" align="left"><input id="txtBeginValue" name="beginValue" readonly="readonly" type="text" runat="server"/></td>
					</tr>
					<tr>
						...
						<td class="item_content" align="left"><input id="txtEndValue" name="endValue" readonly="readonly" type="text" runat="server"/></td>
					</tr>
					<tr>
