...
public partial class finance_find_SearchOrderCountByEmployee : System.Web.UI.Page
{
    ...
    private void InitData() 
    {
        ...
        //lbEmployee.DataSource = model.EmployeeList;
        //lbEmployee.DataValueField = "Id";
        //lbEmployee.DataTextField = "Name";
        //lbEmployee.DataBind();
        //lbPosition.DataSource = model.PositionList;
        //lbPosition.DataValueField = "Id";
        //lbPosition.DataTextField = "Name";
        //lbPosition.DataBind();
    ...
    {
        if (null != Request.Form["position"] && "-1" != Request.Form["position"])
        {
    ...
    private void QueryNextPageData(int currentPageIndex) 
    {
        try
        {
            ...
            {
                model.Employee.PositionIdString = txtBeginDateTime.Value;
            }
            if ("" != txtTo.Value)
            {
                model.Employee.No = txtTo.Value;
            }
    ...
    protected void btnPrint_ServerClick(object sender, EventArgs e)
    {
        ...
        rart.CreateReport(model, "按人员统计工单量", "按人员统计工单量", PageSize.A4, 10, 10, 10, 10);
        Page.ClientScript.RegisterStartupScript(this.GetType(), "pdf", "<script type=''>showPage('../../reports/" + reportFileName + "', '按人员统计工单量', 1024, 1024 , false, false, null);</script>");
    }
    #endregion
    #region//分页处理程序
