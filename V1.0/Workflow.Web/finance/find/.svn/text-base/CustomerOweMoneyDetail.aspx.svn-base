				...
				<td align="center">
				    <table width="100%" border="1" cellpadding="2" cellspacing="1" >
                      ...
                      <%
                          ...
                          {
                              index++;
                              oweMoneyTotal += order.SumAmount - order.Concession - order.Zero - order.RenderUp - order.PaidAmount;
                            %>
                      <tr  class="detailRow">
                        <td><%=index %></td>
                        ...
                        <td align="right"><%=Workflow.Util.NumericUtils.ToMoney(order.SumAmount-order.Concession-order.Zero-order.RenderUp-order.PaidAmount) %></td>
                      </tr>
                      <%
                          }
                           %>
                      <tr>
                          <td>欠款合计</td>
                          <td align="right" colspan="9"><%=Workflow.Util.NumericUtils.ToMoney(oweMoneyTotal) %></td>
                      </tr>
                    </table>
                </td>                              
				<td width="3%" >&nbsp;</td>
