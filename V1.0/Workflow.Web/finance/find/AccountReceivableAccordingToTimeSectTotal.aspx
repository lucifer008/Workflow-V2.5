								  ...
								  {%>
                                    <table width="100%" heigth="100%" border="1" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr class="detailRow">
                                            ...
                                            <td class="num" ><%=Workflow.Util.NumericUtils.ToMoney(model.OrderTempList[i].AccountReceviableOweMomeyTotal)%></td>
                                            <td><%=FindFinanceAction.OrderModel.OrderTempList[i].Memo%></td>
                                            <td><a href="#" onclick="showOweMoneyDetail(<%=model.OrderTempList[i].CustomerId %>,'<%=model.OrderTempList[i].CustomerName %>')">明细</a></td>
                                        </tr>
                                        <%}
                                        %>
                                        <tr class="detailRow">
