                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="5" class="item_content">
                                                            <input name="MemberCardNo" type="text" class="texts" value="<%=model.NewOrder.MemberCardNo %>"
                                                                id="txtMemberCardNo" onblur=" return memberCardChange(event,this);" /><input type="button" id="Accredit" value="手动输入会员卡号" disabled="true" onclick="accredit();" /><input type="hidden" name="MemberCardId" id="txtMemberCardId" value="<%=model.NewOrder.MemberCardId %>" /><input
                                                        ...
                                                        <tr name="">
                                                            ...
                                                            <%string strPrint = "";
                                                              ...
                                                              strPrint += " " + model.OrderItem[j].Memo;
                                                                   %>
                                                                <a href="#" onclick="showPrintRequest(this);"><%if (!Workflow.Util.StringUtils.IsEmpty(strPrint.Trim())) { Response.Write(strPrint); } else { Response.Write("选择"); } %></a><input id="factorid<%=j+1 %>" name="txtFactorId<%=j+1 %>"
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="button" onclick="deleteOneOrderitem(this);" value="删除" /></td>
                                                        </tr>
                                                        <%}
                                                      }
                                                      else
                                        ...
                                        <tr>
                                            <td align="center" class="bottombuttons" colspan="3">
                                                ...
                                                <input name="blankOut" id="btnBlankOut" type="button" class="buttons" onclick="blankOutRecord()"
                                                    value="废稿" style="display:none" />
                                                <asp:Button Text="重新分配人员" CssClass="buttons" ID="btnReturn" OnClientClick="return realOrderDataCheck(); " OnClick="OrderReturn" runat="server" />
                                                ...
                                                <input name="Submit33423" type="button" class="buttons" onclick="window.close()"
                                                    value="关闭" /><input type="hidden" name="OrdersId" value="<%=model.NewOrder.Id %>" />
                                            </td>
                                        </tr>
