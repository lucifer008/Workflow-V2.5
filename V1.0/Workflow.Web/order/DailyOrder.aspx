                ...
                <tr>
                    <td colspan="3" bgcolor="#FFFFFF">
                        <table  border="0" cellspacing="0" cellpadding="0" style=" width:100%;" >
                            <tr>
                                <td></td>
                                <td align="left" bgcolor="#eeeeee">首页 -> 工单管理 -&gt; 本日工单</td>
                                <td></td>
                            </tr>
                            <tr>
                                            ...
                                            <td colspan="6">
                                                <table id="orderDetail" style="width: 100%; height: 100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="item_content">
                                                            <div>
                                                                <input id="txtDeliveryDateTime" name="txtDeliveryDateTime" onfocus="setDayInit(this);" type="text" class="datetimetexts" readonly="true" size="20" maxlength="16"/>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                            ...
                            <tr id="tr3">
                                ...
                                <td align="center">
                                    <table width="100%">
                                        <tr>
                                            <td width="25%" align="left"><input type="button" onclick="addRow();" class="buttons" value="新增业务明细" id="btnNewOrderItem1" /></td>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <table width="100%">
                                        <tr>
                                            <td width="25%" align="left"><input type="button" onclick="addRow();" class="buttons" value="新增业务明细" id="btnNewOrderItem2" /></td>
                                            <td width="75%" colspan="2" align="right">&nbsp;&nbsp;&nbsp;<asp:Button Text="保存&amp;打印" CssClass="buttons" ID="btnDispatchAndPrint2" OnClientClick="return orderDataCheck(); " OnClick="btnDispatchAndPrint2_ServerClick" runat="server" /></td>
                                        </tr>
                                    </table>
                                </td>
                                <td style="width: 3%">&nbsp;</td>
                            ...
                            <tr class="emptyButtonsUpperRowHight">
                                <td colspan="3" class="caption">本日工单</td>
                            </tr>
                            <tr>
                                <td style="width: 3%">&nbsp;</td>
                                <td align="left" style="overflow:hidden;">
                                  <iframe id="mfram" name="mframe" style="width: 100%; height: 650px;" frameborder="0" scrolling="no" src=""></iframe>
                                </td>
                                <td style="width: 3%">&nbsp;</td>
                            </tr>
                            <tr class="emptyButtonsUpperRowHight">
