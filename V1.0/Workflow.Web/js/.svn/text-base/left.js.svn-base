...
var TREE_ITEMS = [
	['快印易', null,
		['工单管理', null,
		    ['本日工单', 'order/DailyOrder.aspx'],
		    ['工单查询', 'order/SearchOrder.aspx'],
		    ['上门取活', 'order/GetOrder.aspx']
		    
		],
		['绩效管理', null,
		    ['绩效调整',                'achievement/AdjustAchievement.aspx'],
		    ['绩效查询',  				'achievement/SearchAchievement.aspx'],
		    ['工单绩效分配情况',      'achievement/AchievementComposition.aspx'],
		    ['员工绩效统计',      'achievement/AchievementUselessPaperSum.aspx'],
		    ['店长经理绩效统计',      'achievement/AchievementShoperOrManagerSum.aspx']
		],
		['客户管理', null,
		    ['客户一览', 'customer/CustomerList.aspx'],
		    ['客户添加', 'customer/NewCustomer.aspx'],
		    ['客户确认', 'customer/CustomerValidate.aspx'],
		    ['客户查询', 'customer/SearchCustomer.aspx']
		],
		['会员管理', null,
		    ['会员一览',          'membercard/MemberCardList.aspx'],
		...
		['抄表处理', null,
		    ...
		    ['计数器查询', 'logcounters/EditProductionPaperAmount.aspx']
		],
		['活动管理', null,
