<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AchievementDetailByManagerOrShoper.aspx.cs" Inherits="achievement_AchievementDetailByManagerOrShoper" %>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0">
          <tr>
            <td></td>
            <td align="left" bgcolor="#eeeeee">首页 -&gt; 绩效管理 -&gt; 绩效</td>
            <td></td>
          </tr>
          <tr>
            <td colspan="3" class="caption" align="center">绩效</td>
          </tr>
          ...
          <tr>
            ...
            <td align="left"><table width="100%" border="1" cellspacing="1" cellpadding="3">
                <tr>
                  <td width="20%" nowrap="nowrap" class="item_caption">岗位:</td>
                ...
                <tr>
                  <td width="20%" nowrap="nowrap" class="item_caption">统计月份:</td>
          ...
          <tr>
            ...
            <td align="center"><table width="100%" border="1" cellpadding="3" cellspacing="1">
                <tr>
                  ...
                  <th width="10%" align="center" nowrap="nowrap">工单号</th>
