                        ...
                        <%
                          if(null!=model.HandOverList)
                          {
                              ...
                              <tr class="detailRow">
                                ...
                                <td nowrap="nowrap"><%=Convert.ToDateTime(var.HandOverDateTime).ToString("yyyy-MM-dd HH:mm")%></td>
                                <td align="left"><%=var.Memo%></td>
                                <%
                                  if (var.HandOverType == Constants.HANDER_OVER_FRONT.ToString())
                                  {
                                      %>
                                <td nowrap="nowrap"><a href="#" onclick="displayStageHandOverDetail(<%=var.Id%>)">详细</a></td>
                                    <%
                                  }
                                else
                                  {
                                       %>
                                <td nowrap="nowrap"><a href="#" onclick="displayCasherHandOverDetail(<%=var.Id%>)">详细</a></td>
                                  <%
