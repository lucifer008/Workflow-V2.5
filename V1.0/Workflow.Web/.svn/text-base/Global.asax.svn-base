...
<script runat="server">
    ...
    { 
        // 在出现未处理的错误时运行的代码
        //Workflow.Support.Log.LogHelper.WriteError((Exception)e, Workflow.Support.Constants.LOGGER_NAME);
    }
    ...
    void Session_End(object sender, EventArgs e) 
    {
        ...
        Workflow.Da.Domain.User user = ((Workflow.Da.Domain.User)(((Workflow.Support.ThreadLocalUtils)(Session[0])).CurrentUser));
