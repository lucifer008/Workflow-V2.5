      ...
      <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0">
          ...
          <tr>
            ...
            <td align="center"><table width="100%" border="1" cellpadding="3" cellspacing="1">
                ...
                <tr class="detailRow">
                  <td align="left"><%=conversion.MachineName %></td>
                  <td><%=conversion.PaperName %></td>
                  ...
                  <td class="num"><%=conversion.CashCount%></td>
                  <td class="num"><%=conversion.PatchCount %></td>
                  <%if(conversion.Result=="不差"){ %>
					<td><span style="color:Green"><%=conversion.Result %></span></td>
					<%}else{ %>
					<td><span style="color:Red"><%=conversion.Result %></span></td>
					<%} %>
                </tr>
                <%} %>
              </table></td>
          ...
          <tr>
            ...
            <td align="center"><table width="100%" border="1" cellpadding="3" cellspacing="1">
                ...
                <%foreach (Workflow.Da.Domain.CompensateUsedPaper compensate in model.CompensateUsedPaperList)
				  { %>
               <tr>
                  <td height="18" align="left"><%=compensate.Machine.Name%></td>
