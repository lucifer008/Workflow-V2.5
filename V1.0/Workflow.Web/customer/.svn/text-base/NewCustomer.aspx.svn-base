...
function arrear(t)
{
    if($("#cbPaymentType").attr("value")==<%=Workflow.Support.Constants.PAYMENT_TYPE_ACCOUNT_GET_VALUE %>)
    {
            ...
            <table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
              ...
              <tr>
			   ...
			   <tr>
                ...
                <td colspan="2" class="item_content"><asp:TextBox ID="EMAIL" runat="server" MaxLength="50"></asp:TextBox></td>
              </tr>
			  <tr>
                <td nowrap class="item_caption">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务</td>
			     ...
			     <td colspan="2" class="item_content"><asp:TextBox ID="Hobby" runat="server" MaxLength="100"></asp:TextBox></td>
			  </tr>
			  <tr>
                <td nowrap class="item_caption">Q&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q</td>
			     <td class="item_content"><asp:TextBox ID="QQ" runat="server"  MaxLength="20"></asp:TextBox></td>
			     <td nowrap class="item_caption">发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票</td>
			     <td class="item_content">
                    <asp:CheckBox ID="NeedTicket" runat="server" Text="需要" />
                    <asp:HiddenField ID="CustomerId" runat="server" />
                    <asp:HiddenField ID="ParentPage" runat="server" Value="F" />
                </td>                    
			  </tr>
			    
			  <tr>
			    <td nowrap class="item_caption">支付方式</td>
			    <td class="item_content" colspan="4"><select name="sltPayType" id="cbPaymentType" onchange="arrear(5);" runat="server"></select></td>
			  </tr>
              <tr>
