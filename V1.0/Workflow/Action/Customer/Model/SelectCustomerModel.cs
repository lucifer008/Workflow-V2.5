...
{
    /// <summary>
    /// 名    称: Workflow.Action.Model.SelectCustomerModel
    /// 功能概要: 查询用户需要的客户数据
    /// 作    者: liuwei
    /// 创建时间: 2007-9-11
    /// 修正履历: 
    ...
    public class SelectCustomerModel
    {
        ...
        private IList<Workflow.Da.Domain.Customer> customerList;
        public IList<Workflow.Da.Domain.Customer> CustomerList
        {
            get { return customerList; }
            set { customerList = value; }
        }

        private string isNotDisplay;
        public string IsNotDisplay 
        {
            set { isNotDisplay = value; }
            get { return isNotDisplay; }
        }
