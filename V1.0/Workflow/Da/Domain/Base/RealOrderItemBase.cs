...
{
	/// <summary>
	/// Table REAL_ORDER_ITEM (实际工单明细) 对应的DotNet Object 基类
	/// 这个类是基类，不允许修改
	/// </summary>
	[Serializable]
    public class RealOrderItemBase : Workflow.Da.Domain.Base.MetaData 
	{
		...
		{
			get { return trashPapers ;	}
			set { trashPapers=value;		}	
		}
		#endregion
		...
		/// <summary>
		/// Source Table[REAL_ORDER_ITEM] Column[REAL_ORDER_ITEM_ID] --> Target IList<Table[PRINT_REQUIRE_DETAIL]> Column[ID]
		/// PropertyComment	:PRINT_REQUIRE_DETAIL[REAL_ORDER_ITEM_PRINT_REQUIRE]:list
		...
		#region REAL_ORDER_ITEM_FACTOR_VALUE JoinType 1:N	list_in
		private IList<Workflow.Da.Domain.RealOrderItemFactorValue> realOrderItemFactorValueList; 
		/// <summary>
		/// Source Table[REAL_ORDER_ITEM] Column[ID] --> Target IList<Table[REAL_ORDER_ITEM_FACTOR_VALUE]> Column[REAL_ORDER_ITEM_ID]
		/// PropertyComment	:REAL_ORDER_ITEM_FACTOR_VALUE:list
		/// JoinType 1:N	list_in
		/// </summary>
		public virtual  IList<Workflow.Da.Domain.RealOrderItemFactorValue> RealOrderItemFactorValueList
		{
			get { return realOrderItemFactorValueList;	}
			set { realOrderItemFactorValueList = value;	}
		}
		#endregion

		#region TRASH_PAPER_EMPLOYEE JoinType 1:N	list_in
		private IList<Workflow.Da.Domain.TrashPaperEmployee> trashPaperEmployeeList; 
		/// <summary>
		/// Source Table[REAL_ORDER_ITEM] Column[ID] --> Target IList<Table[TRASH_PAPER_EMPLOYEE]> Column[REAL_ORDER_ITEM_ID]
		/// PropertyComment	:TRASH_PAPER_EMPLOYEE:list
		/// JoinType 1:N	list_in
		/// </summary>
		public virtual  IList<Workflow.Da.Domain.TrashPaperEmployee> TrashPaperEmployeeList
		{
		...
		#region REAL_ORDER_ITEM_TRASH_REASON JoinType 1:N	list_in
		private IList<Workflow.Da.Domain.RealOrderItemTrashReason> realOrderItemTrashReasonList; 
		/// <summary>
		/// Source Table[REAL_ORDER_ITEM] Column[ID] --> Target IList<Table[REAL_ORDER_ITEM_TRASH_REASON]> Column[REAL_ORDER_ITEM_ID]
		/// PropertyComment	:REAL_ORDER_ITEM_TRASH_REASON:list
		/// JoinType 1:N	list_in
		/// </summary>
		public virtual  IList<Workflow.Da.Domain.RealOrderItemTrashReason> RealOrderItemTrashReasonList
		{
			get { return realOrderItemTrashReasonList;	}
			set { realOrderItemTrashReasonList = value;	}
		}
		#endregion

		#region REAL_ORDER_ITEM_EMPLOYEE JoinType 1:N	list_in
		private IList<Workflow.Da.Domain.RealOrderItemEmployee> realOrderItemEmployeeList; 
		/// <summary>
		/// Source Table[REAL_ORDER_ITEM] Column[ID] --> Target IList<Table[REAL_ORDER_ITEM_EMPLOYEE]> Column[REAL_ORDER_ITEM_ID]
		/// PropertyComment	:REAL_ORDER_ITEM_EMPLOYEE:list
		/// JoinType 1:N	list_in
		/// </summary>
		public virtual  IList<Workflow.Da.Domain.RealOrderItemEmployee> RealOrderItemEmployeeList
		{
