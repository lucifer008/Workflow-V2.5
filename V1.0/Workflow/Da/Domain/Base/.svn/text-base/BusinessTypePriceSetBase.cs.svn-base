...
{
	/// <summary>
	/// Table BUSINESS_TYPE_PRICE_SET 对应的DotNet Object 基类
	/// 这个类是基类，不允许修改
	/// </summary>
	[Serializable]
	public class BusinessTypePriceSetBase : Workflow.Da.Domain.Base.MetaData 
	{
		/** ID [ID] */
		private long id;
		/** 基本业务类别的价格分类_ID [BASE_BUSINESS_TYPE_PRICE_SET_ID] */
		...
		/** 价格折扣 [PRICE_CONCESSION] */
		private decimal priceConcession;

		public BusinessTypePriceSetBase()
		{
		...
		{
			get { return this.baseBusinessTypePriceSetId; }
			set { this.baseBusinessTypePriceSetId = value; }
		}
		/// <summary>
		/// 价格类别 [PRICE_TYPE]
		/// </summary>
		public virtual long PriceType
		{
		...
		/// 价格折扣 [PRICE_CONCESSION]
		/// </summary>
		public virtual decimal PriceConcession
		{
			get { return this.priceConcession; }
			set { this.priceConcession = value; }
		}

		private Workflow.Da.Domain.BusinessType businessType;
		/// <summary>
		/// Source Table[BUSINESS_TYPE_PRICE_SET] Column[BUSINESS_TYPE_ID] --> Target Table[BUSINESS_TYPE] Column[ID]
		/// </summary>
