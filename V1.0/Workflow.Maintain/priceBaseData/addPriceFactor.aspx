				...
				<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
                  ...
                  <tr>
						<td nowrap class="item_caption">对应的表</td>
						 <td class="item_content" align="left"><input id="txtTargetTable" name="targetTable" type="text" runat="server"/></td>
						 <td nowrap class="item_caption">对应值的列</td>
						 <td class="item_content" align="left"><input id="txtTargeValueColumn" name="targetValueColumn" type="text" runat="server"/></td>
						 <td nowrap class="item_caption">对应文本的列</td>
						 <td class="item_content" align="left"><input id="txtTargetTextColumn" name="targetTextColumn" type="text" runat="server"/></td>
                  </tr>
				</table>
			</tr>
			<tr>
				<td colspan="4" align="left"  class="bottombuttons">
				<input id="btnNewPriceFactor" name="newPriceFactor" class="buttons" type="button" onclick ="addPriceFactor();" value="新增价格因素" runat="server" />
