...
namespace Workflow.Service.Impl
{
    ...
    public class HandOverServiceImpl:IHandOverService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string DailyPaperMaxHandOverDateTime(string queryDateTime) 
        {
            return handOverDao.DailyPaperMaxHandOverDateTime(queryDateTime);
        }
        ...
        /// <remarks>
        /// 作    者: 张晓林
        /// 创建时间: 2010年1月14日14:57:28
        /// 修正履历:
        /// 修正时间:
        /// </remarks>
        public decimal GetCurrentHandOverMemChargeAmount(Hashtable condition) 
        {
            return gatheringDao.GetCurrentHandOverMemChargeAmount(condition);
        }
        ...
        {
            return gatheringDao.GetDailyScotAmount(condition);
        }
