...
namespace Workflow.Service.SystemManege.PriceManage
{
   ...
   public interface IPriceService
   {
       ...
       void BatchDeletePrice(IList<string> strBaseBusinessTypePriceSetList);
       ...
       string GetTargetName(BusinessTypePriceSet bizPriceSet);
	    ...
	    /// <param name="baseBusinessTypePriceSet"></param>
	    /// <returns></returns>
		IList<BaseBusinessTypePriceSet> GetBaseBusinessTypePrices(BaseBusinessTypePriceSet baseBusinessTypePriceSet);
		...
		/// 创建时间: 2009.5.19
		/// </remarks>
		IList<OrderItem> GetOrderItemBaseBusinessTypePriceSet(string orderNo);
       ...
       /// <summary>
        ...
        /// 修正时间: 
        /// </summary>
       void DeleteMembercardPrice(IList<BusinessTypePriceSet> businessTypePriceSetList);
        #endregion
	   ...
	   void UpdateBaseBusinessTypePrice(IList<BaseBusinessTypePriceSet> iList);
	   ...
	   /// </summary>
	   /// <param name="iList"></param>
	   void UpdateBusinessTypePrice(IList<BusinessTypePriceSet> iList);
	   ...
	   /// 描    述:
	   /// </summary>
	   BaseBusinessTypePriceSet GetTheMostBaseBusinessTypePrice(BaseBusinessTypePriceSet domain);
	   #endregion
   }
}
