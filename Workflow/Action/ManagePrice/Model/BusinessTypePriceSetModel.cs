...
namespace Workflow.Action.Model
{
    public class BusinessTypePriceSetModel
    {
        ...
        {
            get {
				if (businessTypePriceSetList == null)
					businessTypePriceSetList = new List<BusinessTypePriceSet>();
        ...
        private IList<long> membercardPriceIdList=new List<long>();
        public IList<long> MembercardPriceIdList 
        {
            set { membercardPriceIdList = value; }
            get { return membercardPriceIdList; }
        }
