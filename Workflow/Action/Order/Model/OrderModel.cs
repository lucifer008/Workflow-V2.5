...
namespace Workflow.Action.Model
{
    ...
    public class OrderModel
    {
        ...
        private decimal memberCardAmountTotal;
        public decimal MemberCardAmountTotal
        {
            set { memberCardAmountTotal = value; }
            get { return memberCardAmountTotal; }
        }
        ...
        private IList<OrderItemMortgage> orderItemMortgageList;
        public IList<OrderItemMortgage> OrderItemMortgageList 
        {
            set { orderItemMortgageList = value; }
            get { return orderItemMortgageList; }
        }

        private OrderMortgageRecord orderMortgageRecord;
        public OrderMortgageRecord OrderMortgageRecord 
        {
            set { orderMortgageRecord = value; }
            get { return orderMortgageRecord; }
        }
        ...
        public int OrderPrintCount 
        {
            set { orderPrintCount = value; }
            get { return orderPrintCount; }
        }
        private string[] orderItemIdArr;
        public string[] OrderItemIdArr
        {
            set { orderItemIdArr = value; }
            get { return orderItemIdArr; }
        }
        private OrderItem orderItemTemp;
        public OrderItem OrderItemTemp 
        {
            set { orderItemTemp = value; }
            get { return orderItemTemp; }
        }
        private IList<Order.DateOptionCard> dateList=new List<Order.DateOptionCard>();
        public IList<Order.DateOptionCard> DateList 
        {
            set { dateList = value; }
            get { return dateList; }
        }
