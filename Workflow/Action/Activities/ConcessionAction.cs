...
namespace Workflow.Action
{
    ...
    public sealed class ConcessionAction
    {
        ...
        {
            model.ConcessionList = campaignService.GetAllConcessionByCampaignId(model.CampaignId);
			model.DiscountConcessionList = campaignService.GetAllDiscountConcessionByCampaignId(model.CampaignId);
