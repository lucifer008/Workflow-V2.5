...
namespace Workflow.Da.Impl
{
    ...
    public class ConcessionDaoImpl : Workflow.Da.Base.DaoBaseImpl<Concession>, IConcessionDao
    {
		...
		/// 创建时间: 2009.5.13
		/// </remarks>
		public IList<Concession> SelectAllConcessByCampaignId(long campaignId)
		{
			return sqlMap.QueryForList<Concession>("Concession.SelectAllConcessByCampaignId", campaignId);
		}
        ...
        /// 删除所有活动基于的门市价格
        /// </summary>
        /// <param name="baseBusinessTypeSetId"></param>
        /// <remarks>
        /// 作    者：张晓林
        /// 创建时间: 2010年1月15日16:37:54
        /// 修正履历:
        /// 修正时间:
        /// </remarks>
        public void DeleteConcession(long baseBusinessTypeSetId) 
        {
            sqlMap.Delete("Concession.DeleteConcession",baseBusinessTypeSetId);
        }
	}
}
