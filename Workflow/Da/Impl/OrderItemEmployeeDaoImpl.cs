...
namespace Workflow.Da.Impl
{
    ...
    public class OrderItemEmployeeDaoImpl : Workflow.Da.Base.DaoBaseImpl<OrderItemEmployee>, IOrderItemEmployeeDao
    {
        ...
        public IList<OrderItemEmployee> GetOrderItemEmployeeListByOrderNo(string orderNo) 
        {
            ...
            orderItemEmployee.PositionName = ThreadLocalUtils.CurrentUserContext.CurrentUser.BranchShopId.ToString();
            orderItemEmployee.PositionId = ThreadLocalUtils.CurrentUserContext.CurrentUser.CompanyId;
            return sqlMap.QueryForList<OrderItemEmployee>("OrderItemEmployee.GetOrderItemEmployeeListByOrderNo", orderItemEmployee);
        }
        #endregion
    }
}
