...
namespace Workflow.Da.Impl
{
    ...
    public class DiscountConcessionDaoImpl : Workflow.Da.Base.DaoBaseImpl<DiscountConcession>, IDiscountConcessionDao
    {
		...
		/// 创建时间: 2009.5.13
		/// </remarks>
		public IList<DiscountConcession> SelectAllDiscountConcessionByCampaignId(long campaignId)
		{
			return sqlMap.QueryForList<DiscountConcession>("DiscountConcession.SelectAllDiscountConcessionByCampaignId", campaignId);
		}
