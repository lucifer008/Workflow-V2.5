...
{
	/// <summary>
	/// Table BUSINESS_MODULE (业务模块) 对应的DotNet Object 基类
	/// 这个类是基类，不允许修改
	/// </summary>
	[Serializable]
	public class BusinessModuleBase
	{
		...
		#region BusinessModuleGroupId
		/* 业务模块组_ID [BUSINESS_MODULE_GROUP_ID] */
		private long businessModuleGroupId;
		/// <summary>
		/// 业务模块组_ID [BUSINESS_MODULE_GROUP_ID]
		/// </summary>
		public virtual long BusinessModuleGroupId
		{
			get { return businessModuleGroupId ;	}
			set { businessModuleGroupId=value;		}	
		}
		#endregion
