...
{
	/// <summary>
	/// Table PROCESS_CONTENT (加工内容) 对应的DotNet Object 基类
	/// 这个类是基类，不允许修改
	/// </summary>
	[Serializable]
	public class ProcessContentBase:MetaData
	{
		...
		#region PROCESS_CONTENT_ACHIEVEMENT_RATE JoinType 1:N	list_in
		private IList<Workflow.Da.Domain.ProcessContentAchievementRate> processContentAchievementRateList; 
		/// <summary>
		/// Source Table[PROCESS_CONTENT] Column[ID] --> Target IList<Table[PROCESS_CONTENT_ACHIEVEMENT_RATE]> Column[PROCESS_CONTENT_ID]
		/// PropertyComment	:PROCESS_CONTENT_ACHIEVEMENT_RATE:list:autoJoin=true
		/// JoinType 1:N	list_in
		/// </summary>
		public virtual  IList<Workflow.Da.Domain.ProcessContentAchievementRate> ProcessContentAchievementRateList
		{
