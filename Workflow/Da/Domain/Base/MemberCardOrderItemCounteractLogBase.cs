...
{
	/// <summary>
	/// Table MEMBER_CARD_ORDER_ITEM_COUNTERACT_LOG (会员卡订单明细冲减记录) 对应的DotNet Object 基类
	/// 这个类是基类，不允许修改
	/// </summary>
	[Serializable]
	public class MemberCardOrderItemCounteractLogBase  : Workflow.Da.Domain.Base.MetaData 	{
