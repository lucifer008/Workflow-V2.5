...
{
	/// <summary>
	/// Table ORDERS (订单) 对应的DotNet Object 基类
	/// 这个类是基类，不允许修改
	/// </summary>
	[Serializable]
	public class OrderBase  : Workflow.Da.Domain.Base.MetaData 	{
		...
		#region ReceptionUser
		/* 前期接待 [RECEPTION_USER] */
		private long receptionUser;
		/// <summary>
		/// 前期接待 [RECEPTION_USER]
		/// </summary>
		public virtual long ReceptionUser
		{
			get { return receptionUser ;	}
			set { receptionUser=value;		}	
		}
		#endregion
