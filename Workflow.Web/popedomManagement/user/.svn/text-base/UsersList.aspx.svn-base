                                ...
                                <td align="left" width="94%" nowrap>        
                                    <table border="1" width="100%" nowrap>
                                        <tr>
                                            ...
                                            <td class="item_content"><asp:DropDownList ID="sltUserRole"  runat="server" AppendDataBoundItems="True"><asp:ListItem Value="-1">请选择</asp:ListItem></asp:DropDownList></td>
                                        </tr>
                                        <tr>
                                            <td width="80" class="item_caption">用户名</td><td class="item_content"><input type="text" name="txtUserName" /></td>
                                        </tr>
                                        <tr>
                                            <td width="80" class="item_caption">雇员</td><td class="item_content"><input type="text" name="txtEmployeeName" id="txtEmployeeName" /></td>
                                        </tr>
                                        <tr>
                                            <td align="right" colspan="2"><input name="btnSearch" id="btnSearch" type="button" class="buttons" value="查询" runat="server" onserverclick="btnSearch_ServerClick"/></td>
                                        </tr>
                                    </table>
                                </td>
                                <td width="3%" nowrap></td>
                                ...
                                <td align="center">
                                    <table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
                                        ...
                                        <td nowrap><%=index + 1%></td>
                                            ...
                                            <td><%=UserAction.Model.UserList[index].EmployeeName %></td>
