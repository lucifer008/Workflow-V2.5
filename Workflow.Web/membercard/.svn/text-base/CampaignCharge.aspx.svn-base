...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  ...
  <tr>
             ...
             <td align="center">
                <table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="item_content">
                             <select id="sltConcession" name="sltConcession" onchange="getConcessionInfo(this.value);">
                                <option value="-1" >请选择</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td nowrap class="item_caption" align="right">需冲值金额</td>
                        <td colspan="2" class="item_content">
                            <input type="text" id="txtChargeAmount" style="border:0;color:Red" readonly="readonly" name="txtChargeAmount"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="item_content">
                            <div>
					        <input id="txtJoinDate" name="txtJoinDate" class="datetexts" type="text" size="16" readonly="readonly" onfocus="setday(this)"/>
					        </div>     
	    		        </td>
                    </tr>
                    <tr>
	...
	<input type="hidden" id="hiddMemberCardId" name="hiddMemberCardId" value="" />
	<input type="hidden" id="hidCampaignType" name="hidCampaignType" value="" />
	<input type="hidden" id="hidCampaignId" name="hidCampaignId" value="" />
	<input type="hidden" id="hidPaperCount" name="hidPaperCount" value="" />
	<input type="hidden" id="hidActivityPrice" name="hidActivityPrice" value="" />
</form>
</body>
</html>
