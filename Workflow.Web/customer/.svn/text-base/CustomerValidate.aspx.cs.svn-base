...
public partial class CustomerValidate : Workflow.Web.PageBase
{
    ...
    {
        if (null != ViewState["CustomerName"]) 
        {
            action.Model.Name = ViewState["CustomerName"].ToString();
        }
    ...
    protected void Search_Click(object sender, EventArgs e)
    {
        ...
        {
            action.Model.Name = "%"+CustomerName.Text.Trim()+"%";
        }
        ViewState.Add("CustomerName", action.Model.Name);
        CurrentNextPageData(1);
    }
    #endregion
}
