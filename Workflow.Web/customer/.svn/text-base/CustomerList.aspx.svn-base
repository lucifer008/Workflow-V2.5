...
<body style="text-align: center">
    <form id="form1" runat="server" method="post" defaultbutton="SelectCustomer">
                ...
                <tr>
                    <td colspan="3" bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellpadding="0" cellspacing="3" bgcolor="#FFFFFF">
                            <tr>
                                <td width="3%"></td>
                                <td align="left" bgcolor="#eeeeee">首页&nbsp;-&gt;&nbsp;客户管理&nbsp;-&gt;&nbsp;客户编辑</td>
                                <td width="3%"></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="caption" align="center">客户编辑</td>
                            </tr>
                            <tr>
                                <td width="3%"></td>
                                <td align="center">
