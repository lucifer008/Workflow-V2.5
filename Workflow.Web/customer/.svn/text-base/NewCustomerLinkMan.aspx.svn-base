                                ...
                                <td align="center">
                                    <table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="item_content"><input tabindex="7" name="txtIdentityNo" type="text" value="<%=model.LinkMan.IdentityCardNo %>" /></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="item_content"><input tabindex="11" name="txtAddress" type="text" value="<%=model.LinkMan.Address %>" /></td>
                                        </tr>
                                        <tr>
