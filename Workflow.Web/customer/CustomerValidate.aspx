...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	...
	<tr>
        ...
        <tr>
			<td width="3%"></td>
			<td align="left" bgcolor="#eeeeee">首页&nbsp;-&gt;&nbsp;客户管理&nbsp;-&gt;&nbsp;客户合并</td>
			<td width="3%"></td>
		</tr>
		<tr>
		    <td colspan="3" class="caption" align="center">客户合并</td>
		</tr>
		<tr>
		    <td width="3%">&nbsp;</td>
		    <td width="center">
		        <table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
		              <tr>
                        ...
                        <td class="item_content" colspan="3"><asp:TextBox ID="CustomerName" runat="server"></asp:TextBox></td>
                         <td align="right">
                            <asp:Button ID="Search" runat="server" Cssclass="buttons" Text="查询" OnClick="Search_Click" OnClientClick="return searchCheck();"/>
                        </td>
                    </tr>
		        </table>
		    </td>
	   ...
	   <tr>
        ...
        <td align="center" class="bottombuttons">
            ...
            &nbsp;
            &nbsp;&nbsp;
            <asp:Button ID="Validate"  Cssclass="buttons" runat="server" Text="确认" Visible="false" OnClick="UpdateCustomerValidate" OnClientClick="return dataValidate();" />    
            </td>
        <td width="3%">&nbsp;</td>
      </tr>  
        <tr height="5">
