...
public partial class system_pricemanager_EditSpecialPrice : Workflow.Web.PageBase
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int rowCounter = Convert.ToInt32(businessTypePriceSetAction.GetAllBusinessTypePriceSetListCount(businessTypePriceSetAction.Model)); ;
        ...
        this.PhookPager1.TotalRecordCount = rowCounter;
