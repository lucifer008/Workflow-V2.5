...
function doProcess(sourceSelect){
    ...
    source = sourceSelect;
    var url = "../../ajax/AjaxEngine.aspx" + "?Action=Change&BusinessTypeId=" + source.value;
...
function doQuery(){
  ...
  var url1 = "../../ajax/AjaxEngine.aspx" + "?Action=Query&BusinessTypeId=" +id +"&QueryWhere=" + where.toString();
