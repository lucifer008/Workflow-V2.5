...
{
   var o=showPage("NewUsers.aspx?UserId="+escape(userId)+"&RoleId="+escape(roleId),"curWindow",890,566,false,true,null,false);
   if(o=='yes'){
        $("#hiddTag").val("Edmit");
        $("#form1").submit();
   }
...
function LoadUserInfo()
{
    try
    {
         //alert($("#trConfirmPd").attr("Visable"));
