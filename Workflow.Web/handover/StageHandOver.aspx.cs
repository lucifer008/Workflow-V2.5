...
public partial class StageHandOver : Workflow.Web.PageBase
{
    ...
    /// 修正时间:
    /// </remarks>
    private void SaveStageHandOver()
    {
        InitData();
    ...
    private void PrepareHandOverModel()
    {
        ...
        model.HandOver.EmployeeId= Workflow.Support.ThreadLocalUtils.CurrentUserContext.CurrentUser.EmployeeId;   // 2008-11-04 朱静程加;
