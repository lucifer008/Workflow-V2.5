...
<body style="text-align: center">
                  ...
                  <table width="100%" border="0" cellspacing="0">
                      ...
                      <td align="center">
                        <table width="100%" border="1" cellpadding="3" cellspacing="1">
                          ...
                          <tr>
                            ...
                            <td align="center"><p>结款(当班结算款+应收款+税费)</p></td>
                            ...
                            <td class="num" colspan="2"><%=Workflow.Util.NumericUtils.ToMoney(model.CashHandOver.PayForAmountSum)%><input name="txtPayForAmountSum" type="hidden" value="<%=model.CashHandOver.PayForAmountSum%>" /></td>
                    ...
                    <tr>
                      <td colspan="3" align="center" class="bottombuttons"><%--保存&amp;打印--%>
                        ...
                        <input type="button" name="btnOk" class="buttons" onclick="SaveCashHandOver();" value="保存&amp;打印" />
  ...
  <%if(closeFlag){ %>
    window.navigate('CasherHandOver.aspx');
  <%} %>
  </script>