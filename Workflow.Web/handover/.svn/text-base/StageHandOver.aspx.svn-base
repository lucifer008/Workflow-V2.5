...
<body style="text-align: center">
                  ...
                  <table width="100%" border="0" cellspacing="0">
                      ...
                      <td align="center">
                        <table width="100%" border="1" cellpadding="3" cellspacing="1">
                          ...
                          <tr>
                            ...
                            <th width="1%" nowrap="nowrap">订单号</th>
                            <th width="1%" nowrap="nowrap">客户名称</th>
                             <th width="1%" nowrap="nowrap">订单状态</th> 
                          ...
                          <tr>
                          <td colspan="8" style="color:Blue">目前没有可交接的订单</td>
                          </tr>
                          <%}%>
                    ...
                    <tr>
                      <td colspan="3" align="center" class="bottombuttons">
                        ...
                        <input type="button" name="btnOk" class="buttons" onclick="saveStageHandOver();" value="保存&amp;打印" id="Button1" />
  ...
  <%if(closeFlag){ %>
    window.navigate('StageHandOver.aspx');
  <%} %>
  </script>
