...
<table id="tbOrderItem" name="tbOrderItem" align="left" border="1" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr name="">
            ...
            <td name="price">
                -<a href="#"  name="modifyPrice" onclick="modifyPrice(this,2);"></a>
                <input name="unitPrice" type="text" size="10" style="display:none; text-align:right;"  value="0" maxlength="10"/>
            </td>
            <td name="sumMoney">-</td>
            <td>
                <a href="#" onclick="showPrintRequest(this);">选择</a>
                <input type="hidden" name="txtFactorId1" id="factorid1"/>
                <input type="hidden" name="txtFactorValue1"  id="factorvalue1"/>
                <input type="hidden" name="txtPrintRequest1" id="printRequest1"/>
                ...
                <input type="hidden" name="printDemandMemo" />
            </td>
            <td>
