<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReDoOrderForOrderItem.aspx.cs" Inherits="order_ReDoOrderForOrderItem" %>
                ...
                <tr>
                    <td colspan="3" bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td></td>
                                <td align="left" bgcolor="#eeeeee">首页 -> 订单管理 ->本日订单 ->订单返工</td>
                                <td style="width: 12px"></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="caption" align="center">订单返工</td>
                            </tr>
                            <tr>
                                <td width="3%">&nbsp;</td>
                                <td align="left">
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        ...
                                        <tr>
                                          ...
                                          <td class="item_content"><select id="sltDutyMan" name="DutyMan" multiple="multiple">
