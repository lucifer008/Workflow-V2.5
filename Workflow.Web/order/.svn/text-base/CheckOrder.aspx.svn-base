<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckOrder.aspx.cs" Inherits="finance_MortgageOrder" %>
...
<head>
    ...
    <script type="text/javascript" src="../js/order/checkOrder.js"></script>
    <base target="_self" />
</head>
<body style="text-align: center">
<form id="form1" action="" method="post" runat="server">
    <input id="tagAction" name="tagAction" value="" type="hidden" runat="server"/>
    <input id="action" name="action" value="" type="hidden" runat="server"/>
            ...
            <tr>
                <td colspan="3" bgcolor="#FFFFFF">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="3%"></td>
                            <td align="left" bgcolor="#eeeeee">首页 -&gt; 本日订单 -&gt; <%=strTitle %></td>
                            <td width="3%"></td>
                        </tr>
                        <tr>
                            ...
                            <td align="center">
                                <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                    <tr>
                                        ...
                                        <th align="left" nowrap="nowrap">修改批次</th>
                                    </tr>
                                    ...
                                    if (a < model.PriceFactor.Count)
                                    {
                                        ...
                                        { %>
                                                        ...
                                                        <td><%=model.OrderItem[i].Version-1%>次修改</td>
                                                </tr>
                                                <%}
                                                %>
                                            </table>
                        ...
                        <tr>
                            <td colspan="3">
                                <input type="button" id="btnCheck" name="btnCheck" value="确定" class="buttons" onclick="checkData()"/>
                                <input type="button" id="btnClose" name="btnClose" value="关闭" class="buttons" onclick="window.close()"/>
                            </td>
                        </tr>
                        <tr height="5">
