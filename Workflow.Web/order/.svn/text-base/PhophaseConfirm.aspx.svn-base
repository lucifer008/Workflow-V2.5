                ...
                <tr>
                    <td colspan="3" bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td ></td>
                                <td align="left" bgcolor="#eeeeee">首页 -&gt; 订单管理 -&gt; 前期确认</td>
                                <td ></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="caption" align="center">前期确认</td>
                            </tr>
                            <tr>
                                <td width="3%">&nbsp;</td>
                                <td align="left">
                                    ...
                                    <tr>
                                         <td class="item_caption">订单号</td>
                                         <td><input type="text" id="txtOrderNo" name="txtOrderNo" runat="server" /><input type="button" id="btnOk" class="buttons" value="查询" onclick="searchCheck()"/></td>
                                    </tr>
                                    </table>
                                </td>
                                <td width="3%">&nbsp;</td>
                                    ...
                                    <td>
                                        <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                           <tr>
                                            ...
                                            <tr class="detailRow">
                                                <td class="orderStatus">已完成<input type="hidden" name="orderStatusType" value="Sucessed"/></td>
                                                <td><%=model.OrderItemTemp.StatusSucessed %></td>
                                                <td><%--<a href="#" onclick="LookOrderDetail(this)">查看</a>--%></td>
                                           </tr>
                                           <tr class="detailRow">
                                                <td>已提交<input type="hidden" name="orderStatusType" value="Submited" /></td>
                                                <td><%=model.OrderItemTemp.StatusSubmited %></td>
                                                <td><%--<a href="#" onclick="LookOrderDetail(this)">查看</a>--%></td>
                                           </tr>
                                           <tr class="detailRow">
                                                <td class="orderStatus">未提交<input type="hidden" name="orderStatusType" value="NotSubmited" /></td>
                                    ...
                                    <td>
                                        <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                           ...
                                           <tr class="detailRow">
                                                ...
                                                <td><a href="#" onclick="returnOrderDetail(this)">详情</a></td>
                                           </tr>
                                           <%} %>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                           ...
                                           <tr class="detailRow">
                                                ...
                                                <td><a href="#" onclick="phophaseConfirmReturn(this)">新增(只增不改)</a></td>
                                           </tr>
                                           <%} %>
                                        </table>
                                    </td>
                                    ...
                                    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" colspan="3">
                                                <table name="tbTest" border="1" cellpadding="0" cellspacing="0" width="100%" align="left">
                                                    ...
                                                    <tr>
                                                        <td nowrap="nowrap" class="item_caption" style="height: 26px">客户名称:</td>
                                            ...
                                            <td align="center" colspan="3">
                                                <table id="tbOrderItem" name="tbOrderItem" align="left" border="1" cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <th nowrap="nowrap" class="w1">&nbsp;业务类型&nbsp;</th>
                                                            ...
                                                            <th nowrap="nowrap" class="w1" style="display:none">&nbsp;单价&nbsp;</th>
                                                            <th nowrap="nowrap" class="w1" style="display:none">&nbsp;金额&nbsp;</th>
                                                            <th nowrap="nowrap" align="left">制作要求</th>
                                                            ...
                                                            <%string strPrint = "";
                                                              ...
                                                              strPrint += " " + model.OrderItem[j].Memo;
                                                                ...
                                                                <a href="#" onclick="showPrintRequest(this);">
                                                                    <%if (!Workflow.Util.StringUtils.IsEmpty(strPrint.Trim())) { Response.Write(strPrint); } else { Response.Write("选择"); } %>
                                                                </a>
                                        ...
                                        <tr>
                                            <td align="center" class="bottombuttons" colspan="3">
                                                ...
                                                <input name="blankOut" id="btnBlankOut" type="button" class="buttons" onclick="blankOutRecord()" value="废稿" style="display:none" />
                                                <input type="button" id="btnSave" class="buttons" onclick="return phophaseOrderDataCheck();" value="提交"/>
