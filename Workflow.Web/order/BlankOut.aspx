...
<table width="400" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td></td>
				<td align="left" bgcolor="#eeeeee">首页 -&gt; 本日订单 -&gt; 作废订单</td>
				<td></td>
			</tr>
			<tr>
				<td colspan="3" class="caption" align="center">作废订单</td>
			</tr>
			<tr>
				<td width="3%">&nbsp;</td>
				<td align="center">
				<table width="100%" border="1" cellpadding="2" cellspacing="1">
						  ...
						  <tr>
							<td  nowrap class="item_caption">原因:</td>
			...
			<tr > 
				...
				<asp:Button ID="save" CssClass="buttons" Text="确定" OnClick="BlankOutOrder" OnClientClick="return checkData();" runat="server" />
