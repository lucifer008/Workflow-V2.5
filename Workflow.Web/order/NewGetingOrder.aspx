                                ...
                                <td align="center">
                                    <table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="item_content">
                                                <div>
                                                    <input class="datetexts" id="txtFrom" name="txtFrom" readonly="readonly" runat="server" type="text" maxlength="10" onfocus="setday(this)"/>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="item_content">
                                                <div>
                                                    <input class="datetexts" id="txtTo" name="txtTo" readonly="readonly" runat="server" type="text" maxlength="10" onfocus="setday(this)"/>
                                                </div>
                                            </td>
                                            <td nowrap class="item_caption">
                                                完成:
