<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRealFactureOrder.aspx.cs" Inherits="OrderRealFactureOrder" %>
...
<head>
    ...
    <script type="text/javascript" src="../js/order/newRealFactureOrder.js"></script>
                ...
                <tr>
                    <td colspan="3" bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td ></td>
                                <td align="left" bgcolor="#eeeeee">首页 -&gt; 订单管理 -&gt; 修正加订单</td>
                                <td ></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="caption" align="center">修正加订单</td>
                            </tr>
                            <tr>
                                <td width="3%">&nbsp;</td>
                                <td align="center">
                                    ...
                                    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" class="bottombuttons" colspan="3">
                                                ...
                                                <%--<asp:button Text="保存" CssClass="buttons" ID="btnSave" OnClientClick="return realOrderDataCheck(); " OnClick="OrderSave"  runat="server"/>--%>
