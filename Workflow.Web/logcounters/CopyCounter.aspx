    ...
    <div align="center" width="99%" id="container">
			...
			{ %>
										<tr>
											...
											<% foreach (Workflow.Da.Domain.MachineWatch machineWatch in machineType.MachineWatchList)
			  {%>
											<td>
												<input class="check" name="<%=machineType.Name %><%=machineWatch.Id %>" style="text-align:right;width:150px;" type="text" value="" />
											</td>
											<%} %>
										</tr>
										<%} %>
                            ...
                            <tr>
								<td width="3%"></td>
                                <td colspan="" align="left"><div style="float:left;width:100%;">未完成订单用纸数量:</div><input onclick="editProductionPaperAmount();" type="button" value="新增" /></td>
                                <td width="3%"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="center">
									<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
                                        <tr>
                                            <th width="15%" nowrap="nowrap">订单</th>
										...
										<tr>	
											...
											<td nowrap="nowrap"><%=uncomplete.MachineTypeName %></td>
