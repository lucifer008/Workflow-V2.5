...
<head>
  ...
  <title>补单</title>
	...
	<script type="text/javascript" language="javascript" src="../js/compensate.js"></script>
                      ...
                      <td align="center">
                        <table width="100%" border="1" cellspacing="1" cellpadding="3">
                          <tr>
                            ...
                            <td width="94%" align="left" class="item_content">
                              <select id="sltMachine" name="sltMachine">
                                <%foreach (MachineType varMachine in model.MachineTypeList){
									  if (model.MachineTypeId == varMachine.Id)
                                  {%>
                          ...
                          <tr>
                            ...
                            <td align="left" class"item_content">
								<select id="selEmployee" name="selEmployee" size="5" multiple="multiple">
