...
<link href="css/css.css" rel="stylesheet" type="text/css" />
 ...
 <script type="text/javascript">
    ...
    var accreditTypeKey='<%=Workflow.Support.Constants.USER_ACCREDIT_TYPE_LOGINOUT_USER_KEY %>';
    var accreditTypeText='<%=Workflow.Support.Constants.USER_ACCREDIT_TYPE_LOGINOUT_USER_TEXT %>';
    var accreditTypeId=<%=Workflow.Support.Constants.GET_USER_OPERATE_ACCREDIT_LOGIN_OUT_VALUE(Workflow.Support.ThreadLocalUtils.CurrentUserContext.CurrentUser.BranchShopId) %>;//注销用户授权Id
 </script>
</head>
<body bgcolor="#6C7A83" >
