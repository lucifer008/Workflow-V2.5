                                    ...
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        <tr>
                                            ...
                                            <td class="item_content">
                                                <input name="MemberCardNo" id="txtMemberCardNo" type="text" value="" />
                                            </td>
                                             <td nowrap class="item_caption">QQ(MSN):</td>
                                            <td class="item_content">
                                                <input name="txtQQ" id="txtQQ" type="text" value="" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td nowrap class="item_caption">条码号:</td>
                                            <td class="item_content">
                                                <input name="CodeNo" id="txtCodeNo" type="text" value="" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="item_content">
                                                <input name="txtPhone" id="txtPhone" type="text" value="" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td nowrap class="item_caption">身份号:</td>
                                            <td class="item_content">
                                                <input name="txtIdentityNo" id="txtIdentityNo" type="text" value="" />
                                    ...
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        ...
                                        <tr  >
                                            ...
                                            <td>
                                                ...
                                                <%--<a href="#" onclick=" return admentBalaOrder('<%=fModel.OrderList[i].No%>');">修正</a>--%>
