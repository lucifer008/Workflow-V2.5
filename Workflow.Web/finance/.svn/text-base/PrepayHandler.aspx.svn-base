          ...
          <tr>
            ...
            <td align="center">
               <table width="100%" border="1" cellpadding="2" cellspacing="1">
                   <tr>
                      <td nowrap="nowrap" class="item_caption">订 单 号:</td>
                   ...
                   <tr>
                    ...
                    <td class="item_content"><input id="memberCardNo" name="memberCardNo" class="texts" type="text" /></td>
            ...
            <td align="center" >
                <table id="tbList" width="100%" border="1" cellpadding="2" cellspacing="1">
                  <tr>
                    ...
                    <th width="15%" nowrap align="center">订单号</th>
                    ...
                    <th width="10%" nowrap align="center">预付总计</th>
                     ...
                     <tr class='detailRow'>
                          ...
                          <td class="customerName"><%=oModel.OrderList[i].CustomerName%></td>
