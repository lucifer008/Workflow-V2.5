...
<head>
	...
	<script type="text/javascript">
		pagesubmit=function(){
			var beginDate=document.getElementById('txtBeginDateTime');
			var endDate=document.getElementById('txtTo');
                                    ...
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        <tr>
                                            ...
                                            <td width="36%" align="right" style="padding-right: 10px">
                                                <asp:Button ID="btnSearch" CssClass="buttons" runat="server" OnClick="Search" OnClientClick="return pagesubmit();" Text="查询" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td align="center">
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        ...
                                        <tr class="detailRow">
                                            ...
                                            <td class="num">
												<%=model.OrderList[i].SumAmount - model.OrderList[i].PaidAmount - model.OrderList[i].Concession%>
                                            </td>
                                            <td class="num">
