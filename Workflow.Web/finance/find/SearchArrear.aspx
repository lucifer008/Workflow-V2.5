                                ...
                                <td align="center">
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        ...
                                        <tr class="detailRow">
                                            ...
                                            <td class="num" style="color:Blue"><%=Workflow.Util.NumericUtils.ToMoney(model.OrderList[i].SumAmount)%></td>
                                            <td><%=model.OrderList[i].Memo %></td>
                                            <td>
                                                <a href="#" onclick="showOweMoneyDetail(<%=model.OrderList[i].CustomerId %>,'<%=model.OrderList[i].CustomerName %>')">欠款明细</a>
                                                <%--<a href="#" onclick="showPaidMoneyDetail(<%=model.OrderList[i].CustomerId %>,'<%=model.OrderList[i].CustomerName %>')">付款明细</a>--%>
                                            </td>
                                        </tr>
                                        <%}
                                        %>
