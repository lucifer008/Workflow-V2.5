                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        <tr>
                                            <th width="8%" nowrap> &nbsp;N&nbsp; O&nbsp;</th>
                                            <th width="12%" nowrap >订 单 号</th>
                                        ...
                                        <%if (model.OrderTempList != null){
                                            ...
                                            decimal membercardDiffAmountTotal = 0;
                                            for (int i = 0; i < model.OrderTempList.Count; i++)
                                            {
                                                ...
                                                cashTotal += model.OrderTempList[i].PaidAmount - model.OrderTempList[i].RealPaidAmount;//现金合计
                                        ...
                                        <% }%>
                                            <tr class="detailRow">
                                             ...
                                             <tr class="detailRow">
										        ...
										        <td align="right"><%=Workflow.Util.NumericUtils.ToMoney(model.MemberCardAmountTotal) %></td>
										        <td></td>
										        <td></td>
										        <td></td>
                                            </tr>
                                              <tr class="detailRow">
                                                <td align="right">当班税费</td>
                                                <td colspan="8" align="center"><%=Workflow.Util.NumericUtils.ToMoney(model.ScotAmount)%></td>
                                             </tr>
                                            <tr>
                                                <td bgcolor="#eeeeee" align="right" colspan="9"><webdiyer:AspNetPager ID="AspNetPager1" runat="server" OnPageChanging="AspNetPager1_PageChanging"></webdiyer:AspNetPager></td>
                                            </tr>
                                        <% }%>
                                    </table>
