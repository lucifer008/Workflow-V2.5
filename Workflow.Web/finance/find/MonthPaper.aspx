                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        <tr>
                                            <th width="4%" nowrap> NO</th>
                                            <th width="16%" nowrap>现金</th>
                                            <th width="16%" nowrap>记账</th>
											<th width="16%" nowrap>发票</th>
											<th width="16%" nowrap>会员卡冲减金额</th>
											<th width="16%" nowrap>当日营业额合计</th>
											<th width="16%" nowrap>税费</th>
                                        </tr>
                                           <%
                                            decimal accountReceviableTotal = 0;
                                            decimal cashTotal = 0;
                                            decimal paidAmountTotal = 0;
                                            decimal scotAmountTotal = 0;
                                            decimal dailyMoneyTotal=0;
                                            decimal memberDiffAmountTotal = 0;
                                                   ...
                                                   if (1== model.OrderTempList.Count)
                                                   {
                                                     ...
                                                     %>
                                                       <tr class="detailRow">
                                                           ...
                                                           <td class="num" style="color:Red"><%=Workflow.Util.NumericUtils.ToMoney(cashMoney)%></td>
                                                           <td align="right" style="color:Black"><%=Workflow.Util.NumericUtils.ToMoney(model.OrderTempList[0].AccountReceviableOweMomeyTotal)%></td>
											               <td align="right"><%=Workflow.Util.NumericUtils.ToMoney(model.OrderTempList[0].NotPayTicketAmount)%></td>
											               <td align="right"><%=Workflow.Util.NumericUtils.ToMoney(model.OrderTempList[0].RealPaidAmount)%></td>
											               ...
											               <td align="right"><%=Workflow.Util.NumericUtils.ToMoney(model.ScotAmount)%></td>
                                                       </tr>
                                                          <%
                                                        ...
                                                        memberDiffAmountTotal += model.OrderTempList[0].RealPaidAmount;//会员卡冲减金额合计
