                                    ...
                                    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="item_content">
                                               <input type="text" id="CustomerName" name="CustomerName" runat="server" />
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td class="item_content"><input type="text" id="orderNo" name="orderNo" runat="server" /></td>
                                        </tr>
                                        <tr> 
                                ...
                                <td align="center">
                                    <table width="100%" border="1" cellpadding="2" cellspacing="1">
                                        <tr>
                                            ...
                                            <th width="20%"  nowrap align="center"> 订单号</th>
											...
											<tr>
												...
												<td><%=val.PrepareMoneyAmount%></td>
												<td><%=val.Memo %></td>
											</tr>
											
											<%	sumAmount += val.PrepareMoneyAmount;
													i++;
		 } %>
                                        <tr>
                                           <td>合计</td>
