<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AmendmentBalanceOrder.aspx.cs" Inherits="finance_AmendmentBalanceOrder" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../js/finance/amendmentBalanceOrder.js"></script>    
                ...
                <tr>
                    <td colspan="3" bgcolor="#FFFFFF">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td ></td>
                                <td align="left" bgcolor="#eeeeee">首页 -&gt; 订单管理 -&gt; 修正待结算订单</td>
                                <td ></td>
                            </tr>
                            <tr>
                                <td colspan="3" class="caption" align="center">修正待结算订单</td>
                            </tr>
                            <tr>
                                <td width="3%">&nbsp;</td>
                                <td align="center">
                                    ...
                                    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                                                ...
                                                <table name="tbTest" border="1" cellpadding="0" cellspacing="0" width="100%" align="left">
                                                    <tr>
                                                        ...
                                                        <td colspan="5" class="item_content">
                                                            <input name="MemberCardNo" type="text" class="texts" value="<%=model.NewOrder.MemberCardNo %>" id="txtMemberCardNo" onblur=" return memberCardChange(event,this);" />
                                                            <input type="button" id="Accredit" value="手动输入会员卡号" disabled="true" onclick="accredit();" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="5" class="item_content" style="height: 26px">
                                                            ...
                                                            <input name="Input" type="button" class="buttons selectButtons" value="选择客户" id="btnSelectCustomer" onclick="" style="display:none"/>
                                                            <input type="button" name="Submit" class="buttons selectButtons" value="新增客户" id="btnNewCustomer"  style="display:none"/>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap="nowrap" class="item_caption">客户类型<font color="#FF0000">*</font>:</td>
                                                        <td class="item_content">
                                                            <select name="sltCustomerType" id="cbCustomerType" runat="server"></select>
                                                        </td>
                                                        <td nowrap="nowrap" class="item_caption">真实姓名<font color="#FF0000">*</font>:</td>
                                                        <td class="item_content">
                                                            <input name="RealName" type="text" maxlength="50" class="texts" value="<%=model.NewOrder.LinkManName %>" id="txtName" /></td>
                                                        <td nowrap="nowrap" class="item_caption">联系电话:</td>
                                                        <td class="item_content">
                                                            <input name="RealTelNo" type="text" maxlength="20" class="tel" value="<%=model.NewOrder.LastTelNo %>" id="telNo" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td nowrap="nowrap" class="item_caption" style="height: 25px">项目名称:</td>
                                                        <td class="item_content" style="height: 25px">
                                                            <input name="ItemName" type="text" class="texts" maxlength="50" value="<%=model.NewOrder.ProjectName %>" id="txtItemName" />
                                                        </td>
                                                        <td nowrap="nowrap" class="item_caption" style="height: 25px">支付方式:</td>
                                                        <td class="item_content" style="height: 25px">
                                                            <select name="sltPayType" id="cbPaymentType" disabled="true" runat="server"></select>
                                                        </td>
                                                        <td nowrap="nowrap" class="item_caption" style="height: 25px">预收款:</td>
                                                        <td class="item_content" style="height: 25px">
                                                    ...
                                                    <tr>
                                                        <td nowrap="nowrap" class="item_caption" style="display:none;">发票:</td>
                                                        ...
                                                        <tr name="">
                                                            ...
                                                            <%string strPrint = "";
                                                              ...
                                                              strPrint += " " + model.OrderItem[j].Memo;
                                                                   %>
                                                                <a href="#" onclick="showPrintRequest(this);"><%if (!Workflow.Util.StringUtils.IsEmpty(strPrint.Trim())) { Response.Write(strPrint); } else { Response.Write("选择"); } %></a>
                                                                    <input type="hidden" id="factorid<%=j+1 %>" name="txtFactorId<%=j+1 %>"/>
                                                                    <input type="hidden" id="factorvalue<%=j+1 %>" name="txtFactorValue<%=j+1 %>"/>
                                                                    <input type="hidden" id="printRequest<%=j+1 %>" name="txtPrintRequest<%=j+1 %>"/>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type='button' style="display: none" onclick='orderItemEdit(this);' value='编辑' />
                                                                <input type="button" onclick="deleteOneOrderitem(this);" value="删除" />
                                                           </td>
                                                        </tr>
                                                        <%}
                                                      }
                                                      ...
                                                      {%>
                                                            ...
                                                            for (int i = 0; i < businessTypeList.Count; i++)
                                                            {
                                                                ...
                                                                <% for (int i = 0; i < model.PriceFactor.Count; i++)
                                                               {
                                                                ...
                                                                <td>
                                                                    <a href="#" onclick="showPrintRequest(this);">选择</a>
                                                                    <input type="hidden" id="factorid1" name="txtFactorId1"/>
                                                                    <input type="hidden" id="factorvalue1" name="txtFactorValue1"/>
                                                                    <input type="hidden" id="printRequest1" name="txtPrintRequest1"/>
                                                                    <input type="hidden" name="strPrice" />
                                                                    <input type="hidden" name="txtSumMoney" />
                                        ...
                                        <tr>
                                            <td align="center" class="bottombuttons" colspan="3">
                                                <input type="button" onclick="addOneOrderItem();" class="buttons" value="新增业务明细" id="btnNewOrderItem1" />
                                                <input id="btnSave" value="保存" type="button" class="buttons" onclick="realOrderDataCheck()"/>
                                                <input name="Submit33423" type="button" class="buttons" onclick="window.close()" value="关闭" />
