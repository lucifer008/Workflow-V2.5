...
<head>
    ...
    <script type="text/javascript">
        var prophasePositionId=<%=Workflow.Support.Constants.POSITION_PROPHASE_VALUE(Workflow.Support.ThreadLocalUtils.CurrentUserContext.CurrentUser.BranchShopId)%>//前期
        var anaphasePositionId=<%=Workflow.Support.Constants.POSITION_ANAPHASE_VALUE(Workflow.Support.ThreadLocalUtils.CurrentUserContext.CurrentUser.BranchShopId)%>//后期
    </script>
</head>
            ...
            <tr>
                <td colspan="3" bgcolor="#FFFFFF">
                    <table width="100%" border="0" cellspacing="0">
                        <tr>
                            <td></td>
                            <td align="left" bgcolor="#eeeeee">首页 -&gt; 业绩管理 -&gt; 业绩调整</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="caption" align="center">业绩调整</td>
                        </tr>
                        <tr>
                            <td width="3%">&nbsp;</td>
                            <td align="left">
                                <table border="1" cellpadding="3" cellspacing="1" width="100%">
                                    <tr>
                                        ...
                                        <td class="item_content"><input name="strNo" id="txtNo" type="text" class="texts" value="" size="10"/><asp:Button ID="btnSearch" CssClass="buttons" runat="server" OnClick="Search" OnClientClick="return dataQuery();" Text="检索"/></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="3%">&nbsp;</td>
                                    ...
                                    <td align="center">
                                        <table width="100%" border="1" cellpadding="3" cellspacing="1">
                                            <tr>
                                                ...
                                                <th width="10%" align="center" nowrap="nowrap">业绩</th>
                                           ...
                                           <% if (model != null && model.OrderItemList!=null)
                                            ...
                                            <tr class="detailRow" >
                                               ...
                                               <%
                                                      ...
                                                      {
                                                          string color = "red";
                                                          long branchShopId = Workflow.Support.ThreadLocalUtils.CurrentSession.CurrentUser.BranchShopId;
                                                          if (custom.PositionId == Workflow.Support.Constants.POSITION_PROPHASE_VALUE(branchShopId)) 
                                                          {
                                                              color = "Blue";
                                                          }
                                                           %>
                                                      <div id="dProphasePhase<%=custom.Id %>" style="color:<%=color %>">
                                                         <%=custom.Position%>
                                                ...
                                                <%
                                                      foreach (Workflow.Da.Domain.CustomEmployee custom in orderItem.Employees)
                                                      {
                                                          ...
                                                          if (custom.PositionId == Workflow.Support.Constants.POSITION_PROPHASE_VALUE(branchShopId))
                                                          {
                                                            ...
                                                            %> 
                                                  <div id="dProphaseEmName<%=custom.Id %>" style="color:<%=color %>">
                                                    <%=custom.Name%><br />
                                                 </div>
                                                <%
                                                      } %>
                                               ...
                                               <%
                                                 ...
                                                 <input name="money<%=orderItem.Id%><%=custom.Id%><%=custom.PositionId %>" id="positionType<%=custom.PositionId  %>" type="text" style="width:100%;" value="<%=custom.Money %>" />
                                                 <br />
                                                 </div>
                                                <%
                                                      } %>
                                               </td>
                                               <td id="tOIAmount" name="summoney<%=orderItem.Id %>" nowrap="nowrap"><%=orderItem.Money%></td>
                                                  ...
                                                  <select id="prophase" name="sltProphase" size="5" style="width:100%;" multiple="multiple">
                                                    <%
                                                            for (int i = 0; i < model.EmployeeList.Count; i++)
                                                            {
                                                                ...
                                                                <option value='<%=model.EmployeeList[i].Positionid %>,<%= model.EmployeeList[i].Employeeid %>'><%=model.EmployeeList[i].Name%></option>
                                                        <%}
                                                      } %>
                                                  </select>
                                                  <br />
                                                  <input type="hidden" name="orderItemProcessContentRate" value="<%=orderItem.AnaphaseMoney %>" />
                                                  <input type="hidden" name="operatePosition" value="<%=Workflow.Support.Constants.POSITION_PROPHASE_VALUE(Workflow.Support.ThreadLocalUtils.CurrentUserContext.CurrentUser.BranchShopId) %>" />
                                              ...
                                              <td nowrap="nowrap">
                                                <div style="width:100%;height:100%">
                                                  ...
                                                  <br />
                                                  <input type="hidden" name="orderItemProcessContentRate" value="<%=orderItem.AnaphaseMoney %>" />
                                                  <input type="hidden" name="operatePosition" value="<%=Workflow.Support.Constants.POSITION_ANAPHASE_VALUE(Workflow.Support.ThreadLocalUtils.CurrentUserContext.CurrentUser.BranchShopId) %>" />
