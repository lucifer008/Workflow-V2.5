<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addPaperType.aspx.cs" Inherits="priceBaseData_addPaperType" %>
...
<script type="text/javascript" src="../js/priceBaseData/addPaperType.js"></script>
<base target="_self" />
</head>
<body style="text-align:center">
<form id="form1" runat="server" method="post">
<input type="hidden"  id="hiddTag" name="actionTag"/>
<input type="hidden"  id="hidPaperTypeId" name="deletePaperTypeId" runat="server"/>
		...
		<table width="100%" border="0" cellspacing="0">
			...
			<tr>
				...
				<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
					<tr>
						...
						<td class="item_content" align="left"><input id="txtPaperTypeName" name="paperTypeName" type="text" runat="server"/></td>
					</tr>
				</table>
			</tr>
			<tr>
			...
			<tr id="tr1" runat="server">
			    ...
			    <table border="1" cellpadding="3" cellspacing="1" width="100%">
					...
					<%
                        if (null != model.PaperTypeList)
                        {
                            foreach (PaperType paperType in model.PaperTypeList)
                            { 
                            %>
                            <tr class="detailRow">
                                <td class="mName"><%=paperType.Name%></td>
					             <td>
					                <input type="hidden" name="paperTypeId" value="<%=paperType.Id %>"/> 
					                <a href="#" onclick="edmitPaperType(this)" >编辑</a>&nbsp;
					                <a href="#" onclick="deletePaperType(this)">删除</a>
					             </td> 
					           </tr>
                       <%  }
                       }%>
