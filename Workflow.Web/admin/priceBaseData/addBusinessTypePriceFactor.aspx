<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addBusinessTypePriceFactor.aspx.cs" Inherits="priceBaseData_addBusinessTypePriceFactor" %>
...
<script type="text/javascript" src="../js/priceBaseData/addBusinessTypePriceFactor.js"></script>
<script type="text/javascript" language="javascript">
    var businessTypeId='<%= businessTypeId%>';
    var priceFactorArr='<%=priceFactorIds %>';
</script>
<base target="_self" />
</head>
		...
		<table width="100%" border="0" cellspacing="0">
			...
			<tr>
				...
				<td align="center">
				   <table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
					...
					<tr>
						 <td nowrap class="item_caption">价格因素</td>
			...
			<tr id="tr1" runat="server">
			    ...
			    <table border="1" cellpadding="3" cellspacing="1" width="100%">
					...
					<th  nowrap="nowrap" align="center" width="10%">包含的价格因素</th>
					...
					<%
                        if (null != model.BusinessTypeList)
                        {
                            ...
                            {
                                string priceFactorName = SearchPriceBaseDataAction.GetBusniessTypePriceFactor(businessType.Id)[1];
                                if (null != priceFactorName)
                                {
                            %>
                            <tr class="detailRow">
                                <td class="pBusinessTypeName"><%=businessType.Name%></td>
                                <td class="pPriceFactorName"><%=priceFactorName%></td>
					             <td>
					                <input type="hidden" name="businessTypeId" value="<%=businessType.Id%>"/> 
					                <a href="#" onclick="edmitBusinessTypePriceFactor(this)" >编辑</a>&nbsp;
					                <a href="#" onclick="deleteBusinessTypePriceFactor(this)">删除</a>
					             </td> 
					           </tr>
