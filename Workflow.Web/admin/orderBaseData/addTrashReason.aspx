<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addTrashReason.aspx.cs" Inherits="orderBaseData_addTrashReason" %>
...
<script type="text/javascript" src="../js/orderBaseData/addTrashReason.js"></script>
<base target="_self" />
</head>
<body style="text-align:center">
<form id="form1" runat="server" method="post">
<input type="hidden"  id="hiddTag" name="actionTag"/>
<input type="hidden"  id="hidTrashReasonId" name="deleteTrashReasonId" runat="server"/>
		...
		<table width="100%" border="0" cellspacing="0">
			...
			<tr>
				...
				<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
					<tr>
						...
						<td class="item_content" align="left"><input id="txtTrashReasonName" name="trashReasonName" maxlength="20" type="text" runat="server"/></td>
					</tr>
					<tr>
			...
			<tr id="tr1" runat="server">
			    ...
			    <table border="1" cellpadding="3" cellspacing="1" width="100%">
					...
					<%
                        if (null != model.TrashReasonList)
                        {
                            foreach (TrashReason rm in model.TrashReasonList)
                            { 
                            %>
                            <tr class="detailRow">
                                <td class="mName"><%=rm.Name%></td>
                                <td class="mMemo"><%=rm.Memo%></td>
					             <td>
					                <input type="hidden" name="trashReasonId" value="<%=rm.Id %>"/> 
					                <a href="#" onclick="edmitTrashReason(this)" >编辑</a>&nbsp;
					                <a href="#" onclick="deleteTrashReason(this)">删除</a>
					             </td> 
					           </tr>
                       <%  }
                       }%>
