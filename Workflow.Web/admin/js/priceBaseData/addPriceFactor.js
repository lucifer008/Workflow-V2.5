...
{
    var taName=$($(o).parent().parent()).find(".pTable").html();
    var arrTableName=["PROCESS_CONTENT","MACHINE_TYPE","PAPER_TYPE","PAPER_SPECIFICATION","AMOUNT_SEGMENT"];//new Array(5);
    var isTrue=false;
    for(var i=0;i<arrTableName.length;i++)
    {
        if(taName==arrTableName[i])
        {
            isTrue=true;
            break;
        }
