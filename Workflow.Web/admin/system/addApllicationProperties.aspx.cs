...
public partial class system_addApllicationProperties : System.Web.UI.Page
{
    ...
    private void BingEdmitData() 
    {
        if(null!=Request.QueryString["action"] && "edmit"==Request.QueryString["action"])
        {
            ...
            {
                txtPropertyValue.Disabled = true;
                aColor.Visible = true;
                txtPropertyValue.Style["background-color"] = Request.QueryString["PropertyValue"];
                propertyValue.Value = txtPropertyValue.Value;
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try 
        {
            ...
            if ("" != propertyValue.Value.Trim()) systemAction.Model.ApplicationProperty.PropertyValue = propertyValue.Value;
