...
<input type="hidden"  id="ppIdStr" name="ppIdStr" runat="server"/>
		...
		<table width="100%" border="0" cellspacing="0">
			...
			<tr id="tr2">
				...
				<table border="1" cellpadding="3" cellspacing="1" width="100%" align="left">
					<tr>
						...
						<td class="item_content" align="left"><input id="txtPropertyId" name="propertyId" type="text" runat="server"/></td>
						<td nowrap class="item_caption">参数值</td>
						<td class="item_content" align="left">
						    <input id="txtPropertyValue" name="propertyValue" type="text" runat="server"/>
						    <a id="aColor" href="#" onclick="selectColorValue()" runat="server" visible="false">选择颜色</a>
						    <input id="propertyValue" type="hidden" runat="server" />
						</td>
					</tr>
				</table>
			</tr>
			<tr id="tr3">
			    <td align="center" colspan="3">
                    ...
                    <asp:Button ID="btnSave" CssClass="buttons" OnClientClick="return checkProcess(this);" Text="保存" OnClick="BtnSave_Click" runat="server"/>&nbsp;
			...
			<tr id="tr1" runat="server">
			    ...
			    <table border="1" cellpadding="3" cellspacing="1" width="100%">
					<tr>
					<th  nowrap="nowrap" align="center" width="40%">说明</th>
					...
					<%
                        if (null != model.AppliactionPropertyList)
                        {
                            ...
                            %>
                            <tr class="detailRow">
                                <td class="propertyId"><%=ap.Memo%></td>
                                <%if ("Matureness_Color" == ap.PropertyId || "Overdue_Color" == ap.PropertyId)
                                  {%>
                                 <td><div id="divCol" style="width:50px; background-color:<%=ap.PropertyValue %>"></div></td>
                                 <%}else{ %>
                                    <td class="propertyValue"><%=ap.PropertyValue%></td>
                                 <%} %>
					             <td>
					                <input type="hidden" name="applicationPropertyId" value="<%=ap.Id %>"/>
					                <input type="hidden" name="propertyId" value="<%=ap.PropertyId %>"/> 
					                <a href="#" onclick="edmitApplicationProperty(this)" >编辑</a>&nbsp;
					                <input name="edmPropertyValue" type="hidden" value="<%=ap.PropertyValue %>" />
